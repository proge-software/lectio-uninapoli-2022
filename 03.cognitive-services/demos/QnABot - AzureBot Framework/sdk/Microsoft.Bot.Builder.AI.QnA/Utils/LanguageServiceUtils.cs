...
namespace Microsoft.Bot.Builder.AI.QnA
{
    ...
    {
        const string ApiVersionQueryParam = "api-version=2021-10-01";
        ...
        public async Task<QueryResults> QueryKnowledgeBaseAsync(ITurnContext turnContext, IMessageActivity messageActivity, QnAMakerOptions options)
        {
            ...
            var result = await _QueryKnowledgeBaseAsync((Activity)messageActivity, options).ConfigureAwait(false);
        ...
        private async Task<QueryResults> _QueryKnowledgeBaseAsync(Activity messageActivity, QnAMakerOptions options)
        {
        ...
        public async Task UpdateActiveLearningFeedbackAsync(FeedbackRecords feedbackRecords)
        {
            ...
            await _UpdateActiveLearningFeedbackAsync(feedbackRecords).ConfigureAwait(false);
        }

        private async Task _UpdateActiveLearningFeedbackAsync(FeedbackRecords feedbackRecords)
        {
        ...
        /// <summary>
        /// Converts array of metadata, array of sources and corresponding join operations to LanguageService input format - an object of <see cref="StrictFilters"/>
        /// </summary>
        ...
        /// <returns>An object of <see cref="StrictFilters"/></returns>
